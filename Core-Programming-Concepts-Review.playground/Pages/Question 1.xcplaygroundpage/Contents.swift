...
let verticalTranslation = 5
let horizontalTranslation = 2
...
let dependedVariable = verticalScaling * pow(independentVariable - horizontalTranslation,2) + horizontalTranslation
